...
void BulletManager::checkHitMinionEnemyPre(
    MinionEnemyManager *minionEnemyManager, Bullet *bullet)
{
	for (int i = 0; i < MAX_ENEMY_COUNT; i++)
	{
		if (!minionEnemyManager->mEnemies[i]->mIsActive)
		{
			continue;
		}
	...
	for (int i = 0; i < MAX_ENEMY_COUNT; i++)
	{
		if (!minionEnemyManager->mTraceEnemies[i]->mIsActive)
		{
			continue;
		}
	...
	for (int i = 0; i < MAX_ENEMY_COUNT; i++)
	{
		if (!minionEnemyManager->mChargeEnemies[i]->mIsActive)
		{
			continue;
		}
